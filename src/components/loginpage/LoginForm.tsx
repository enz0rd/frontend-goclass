...
const LoginForm = () => {
    ...
    async function handleLogin(data: LoginType) {
        ...
        try {
            ...
            setError({
                errorMessage: error.response?.data?.message || 'Ocorreu um erro desconhecido.',
    ...
    return (
        <div>
            ...
            <div>
                ...
                <p className="text-zinc-900 dark:text-zinc-50">Faça login para ter acesso à sua conta.</p>
            </div>
            <form onSubmit={handleSubmit(handleLogin)} className="flex gap-2 flex-col">
                <div className="w-[100%]">
                ...
                <div className="w-[100%] flex gap-2 flex-col text-center">
                    {isLoading ? (
                        <Button id='login-button' className="w-full bg-primary text-primary-foreground hover:bg-zinc-50 hover:text-primary" disabled>
                            <div role="status">
