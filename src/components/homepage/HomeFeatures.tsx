const HomeFeatures = () => {
  return (
    <div className="relative h-[30rem] sm:h-[30rem] dark:bg-zinc-900 overflow-hidden">
      <div className="flex w-full justify-center overflow-hidden">
        <h1
          className="absolute top-1/2 -translate-y-1/2 left-1/2 transform -translate-x-1/2 text-[10rem] sm:text-[15rem] md:text-[20rem] lg:text-[25rem] font-extrabold text-transparent whitespace-nowrap"
          style={{
      ...
      <div className="absolute top-[20%] lg:top-[40%] w-full">
