      ...
      <div className="container px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 group md:grid-cols-3 gap-6 md:gap-12 mt-12">
          {prices ? (
            ...
            <div className="grid grid-cols-1 h-[20rem] group md:grid-cols-3 gap-6 md:gap-12 mt-12">
              <div role="status">
                <svg aria-hidden="true" className="w-[5rem] h-[5rem] text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
