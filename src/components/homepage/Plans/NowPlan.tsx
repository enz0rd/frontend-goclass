...
const NowPlan = ({ prices }: { prices: Record<string, string> }) => {
        ...
        <CardContent className="mb-4">
          <Tabs defaultValue="mensal">
            ...
            >
              ...
              <NavLink
                to="/register?plan=Now&type=Mensal"
            ...
            >
              ...
              <NavLink
                to="/register?plan=Now&type=Semestral"
                onClick={() => window.scrollTo(0, 0)}
              >
                <Button className="w-full bg-zinc-900 dark:bg-zinc-50 dark:text-primary text-zinc-50 hover:bg-zinc-700 dark:hover:bg-zinc-300">
                  Assinar
            ...
            >
              ...
              <NavLink
                to="/register?plan=Now&type=Anual"
                onClick={() => window.scrollTo(0, 0)}
              >
                <Button className="w-full bg-zinc-900 dark:bg-zinc-50 dark:text-primary text-zinc-50 hover:bg-zinc-700 dark:hover:bg-zinc-300">
                  Assinar
