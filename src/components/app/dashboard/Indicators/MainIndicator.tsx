const MainIndicator = ({ title, number, colorStyle } : { title: string, number: number, colorStyle: Record<string, string> }) => {
    return (
        ...
        flex flex-col text-center justify-center aspect-square w-[20rem] md:w-[100%] lg:w-[100%] bg-zinc-50 dark:bg-zinc-800 border-[.1rem] border-zinc-600 rounded-lg p-4`}>
